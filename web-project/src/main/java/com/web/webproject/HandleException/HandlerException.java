...
public class HandlerException {
  ...
  @ExceptionHandler({UnknownException.class, NoSuchMessageException.class, EmptyResultDataAccessException.class})
  public ResponseEntity<?> handleResourceNotExits(Exception e) {
    LOGGER.error(e.getMessage());
    return ResponseEntity.ok(BaseResponse.builder().code(ApiStatus.UNKNOWN.getCode())
            .message(getMessage("error.message.404")).build());
  }
  /**
